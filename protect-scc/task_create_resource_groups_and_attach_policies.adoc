...
|===
. Optional: Wählen Sie auf der Ressourcen-Seite aus der Dropdown-Liste *Host* einen Hostnamen und einen Ressourcentyp aus der Dropdown-Liste *Ressourcentyp* aus.
+
