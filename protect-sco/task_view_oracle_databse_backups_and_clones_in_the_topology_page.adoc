...
Alternativ können Sie auch auf oder verweisen https://library.netapp.com/ecm/ecm_download_file/ECMLP2885486["SnapCenter Software Command Reference Guide"^] https://docs.netapp.com/us-en/snapcenter-cmdlets-48/index.html["SnapCenter Software Cmdlet Referenzhandbuch"^].
