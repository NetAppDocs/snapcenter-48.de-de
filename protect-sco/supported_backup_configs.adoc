...
** ASM Standalone und ASM RAC on Raw Device Mapping (RDM)
 +
Sie können Backup-, Wiederherstellungs- und Klonvorgänge für Oracle-Datenbanken auf ASM mit oder ohne ASMLib durchführen.
