...
** Daten, die sich auf primären und sekundären ONTAP FAS oder AFF -Systemen befinden und mithilfe der NetApp -Backup- und Recovery-Integration im lokalen StorageGRID -Objektspeicher geschützt sind
...
** Daten, die sich auf primären und sekundären ONTAP FAS oder AFF -Systemen befinden und mithilfe der NetApp Backup- und Recovery-Integration in Objekt- und Archivspeicher in der Cloud geschützt sind
...
+
Weitere Informationen zu Windows-Cmdlets finden Sie unter https://docs.netapp.com/us-en/snapcenter-cmdlets-48/index.html["SnapCenter Software Cmdlet Referenzhandbuch"^].
