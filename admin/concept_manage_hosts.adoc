...
Nachdem Sie die Host-Wartung abgeschlossen haben, können Sie den Host aus dem Wartungsmodus bringen, indem Sie auf *Zeitplan aktivieren* klicken.
Sie können den Zeitplan mehrerer Hosts gleichzeitig aktivieren.
