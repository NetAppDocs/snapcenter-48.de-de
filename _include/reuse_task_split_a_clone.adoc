...
. Wählen Sie in der Ansicht Manage Copies die geklonte Ressource (z. B. die Datenbank oder die LUN) aus, und klicken Sie dann auf * *image:../media/split_cone.gif["Aufteilen"].
