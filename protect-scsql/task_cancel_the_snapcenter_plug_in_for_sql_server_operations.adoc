...
Aktivitätsbereich
 a| 
. Klicken Sie nach dem Initiieren des Backupjobs auf image:../media/activity_pane_icon.gif["Aktivitätssymbol"] das Aktivitätsfenster, um die fünf letzten Vorgänge anzuzeigen.
