...
Die gemeinsam genutzte Festplatte wird nicht mithilfe des Plug-in for Windows erstellt. Sie sollten die Shared-LUN erstellen und dann jeder virtuellen Maschine im Cluster hinzufügen.



=== Verwandte Informationen

Konsultieren Sie  https://techdocs.broadcom.com/["Broadcom Technische Dokumentation"^] und suchen Sie in der Dokumentation nach Hinweisen zum Clustern virtueller Maschinen über physische Hosts hinweg und zum Erstellen gemeinsam genutzter FC RDM LUNs für Microsoft-Cluster.
