...
. Wählen Sie die Klone aus, und klicken Sie dann auf image:../media/delete_icon.gif["Symbol Löschen"] , um Klone zu löschen, oder klicken Sie auf image:../media/split_cone.gif["Klon teilen"] , um die Klone zu teilen.
. Klicken Sie auf *OK*.
